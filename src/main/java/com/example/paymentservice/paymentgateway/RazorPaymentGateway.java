...
public class RazorPaymentGateway implements IPaymentGateway{
    ...
    public String generatePaymentLink(Long amount, String orderId, String phoneNumber, String name, String email) {
        try {
            ...
            paymentLinkRequest.put("expire_by", 1755375610); // make sure this is future value.
            ...
            paymentLinkRequest.put("callback_url", "https://example-callback-url.com/"); //update as per your need
